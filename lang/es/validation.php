...
return [
    ...
    */
    ...
    | especificar rápidamente una línea de idioma personalizada para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para intercambiar nuestro marcador de posición
    | de atributo con algo más amigable para el lector, como "Dirección de Correo Electrónico"
